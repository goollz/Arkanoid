...
public class BlocoBranco extends AbstractBloco{
    ...
    public BlocoBranco(int cX, int cY, int tamX, int tamY, int pontos, Pane painel) throws FileNotFoundException{
        
        super(pontos, cX, cY);
        bloco = super.getBloco(tamX, tamY);
        super.setCor(bloco , "#FFFFFF");
        imagem = new Image(new FileInputStream("src/imagens/sabreBranco.png"));
