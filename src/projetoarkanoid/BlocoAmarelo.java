...
public class BlocoAmarelo extends AbstractBloco{
    ...
    public BlocoAmarelo(int cX, int cY, int tamX, int tamY, int pontos, Pane painel) throws FileNotFoundException{
        
        super(pontos, cX, cY);
        bloco = super.getBloco(tamX, tamY);
        super.setCor(bloco , "#FFFF00");
        imagem = new Image(new FileInputStream("src/imagens/sabreAmarelo.png"));
